...
Use gender project examples: Education and Marriage
...
COVID-19 does not only kill Americans. And now we know that the death toll is much higher. The question is: Is the \$10 billion expenditure noted above a big number or a small number? Or: Should we have spent more on vaccine research in 2020?
...
There is quite a bit of evidence that not all decisions are rational. Many of the examples of irrational behavior do involve a time dimension of either costs or benefits of the decision. Most of us have been there and seen some indication of what irrational behavior might be:
New Year's rolls around and we resolve to start jogging and lose 20 pounds. But by March we have not jogged a mile, have not set foot in a gym, and forget about losing the 20 pounds. From eating all the chocolate, we have gained weight, not lost it.
...
\textbf{(Gym membership, we don't sweat it, but perhaps we should.)}\footnote{
...
Or not. That is exactly the issue studied in \href{https://pubs.aeaweb.org/doi/pdfplus/10.1257/aer.96.3.694}{this paper by Stefano DellaVigna and Ulrike Malmenidier}.
...
These kinds of irrational behaviors often happen when there is temporal element involved, which surely is the case in the choice of picking gym membership contracts.
...
\section{Deadly Demand:}\label{deadly-demand}}
...
{\centering \includegraphics[width=0.45\linewidth]{img/demand/drugalcoholsuicidedeaths} 
...
So much for theory! How big can these effects be? Mulligan uses an estimate of the price elasticity of the demand for alcohol of around 0.85 in absolute value to conclude that such a large drop in the price must be accommodated by a very large increase in the quantity of alcohol consumed.
And a large increase in alcohol consumed leads to the spike in alcohol related deaths.
...
\section[Substitutes Complements in Unexpected Places]{\texorpdfstring{Substitutes Complements in Unexpected Places\footnote{\url{https://d101vc9winf8ln.cloudfront.net/documents/41741/original/Are-Thoughts-and-Prayers-Substitutes-for-Material-Aid-by-Thunstrom-et.al.pdf?1638289404}}}{Substitutes Complements in Unexpected Places}}\label{substitutes-complements-in-unexpected-places}}

Many disasters strike in this country: tornadoes, hurricanes, wildfires, floods, mass shootings, earthquakes, etc., etc., etc. Invariable after such disasters, high profile politician and private citizens offer their condolences. In words like:
...
\tightlist
\item
  The more students are enrolled the more Covid-19 testing units need to be available.
\end{itemize}
...
Average fixed cost is easily graphed as in Figure \ref{fig:supply01}. The fact that this is downward sloping and slowly approaches 0 should not be a surprise. This is just an application of ``the big-little principle'' from middle school. Since fixed costs do not depend on quantity produced, as we are increasing quantity over the x-axis we are spreading the fixed costs out more and more over a larger quantity (denominator for AFC).
...
If the price is \(p_1\), sell \(q_1\). If the price is \(p_2\), sell \(q_2\). Etc.
